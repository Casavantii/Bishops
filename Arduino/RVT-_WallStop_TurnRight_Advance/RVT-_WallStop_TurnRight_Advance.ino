...
void loop() {
  ...
  while ( first == 0 && CenterButton ==1){
    ...
    while ( CenterButton == 1 && third == 0){
      Robot.beep(BEEP_DOUBLE);
         while ( (SensorValueFront < target) && ((SensorValueLeft > (targetLeft*0.95) ) && ( SensorValueLeft < (targetLeft*1.05)))){ // does not enter loop (to be fixed)
           Robot.beep(BEEP_LONG);
            if (SensorValueLeft > targetLeft*1.05){
              while (SensorValueLeft > targetLeft*1.05){
            ...
            else if (SensorValueLeft < targetLeft*0.95){
              while (SensorValueLeft < targetLeft*0.95){
