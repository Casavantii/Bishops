...
//              read();
//            }  
         } /////////////////////////////////////////////////adjust : more of a 620 turn. maybe 1200 delay
      Robot.motorsStop();
      sixth = 1;
  }
    //11/////////////////////////////////turning right until aligned at 90 degrees
    button();
    read();
    ...
    button();
    read();
    ///12////// go along the wall till obstacle///////////////////////////////////
      ...
      Robot.beep(BEEP_DOUBLE);
         ...
         Robot.motorsStop();
         eighth = 1;  
         Robot.beep(BEEP_LONG);Robot.beep(BEEP_LONG);Robot.beep(BEEP_LONG);
       }
